...
static func build() -> Dictionary:
	...
	_add(cards, &"guardian_cover", "엄호 프로토콜", 1, 25, CardData.Scope.GUARDIAN, CardData.Target.ALLY, [{"type": "block", "amount": 6}], ["방어", "지원"], CardData.Rarity.MAGIC)
	...
	_add(cards, &"engineer_patch", "나노 패치", 1, 20, CardData.Scope.ENGINEER, CardData.Target.TEAM, [{"type": "heal", "amount": 4}], ["회복", "지원"], CardData.Rarity.RARE)
	...
	_add(cards, &"neutral_link", "동기화 링크", 1, 10, CardData.Scope.NEUTRAL, CardData.Target.ALLY, [{"type": "energy", "amount": 1}, {"type": "block", "amount": 3}], ["공용", "지원"], CardData.Rarity.MAGIC)
	return cards
